...
- To understand broadly how visitors use our site, using anonymised analytics where applicable.
...
- **Formspree** (or similar form-handling service) to process contact form submissions. Data submitted through the form is transmitted to and temporarily stored by the form provider.
- **Buttondown or Mailchimp** (or similar newsletter service) to manage our mailing list and send newsletters. Your email address is stored by the newsletter provider for as long as you remain subscribed.
...
*This policy was last updated on 27 March 2026.*
